...
public class SSKStore extends StoreCallback<SSKBlock> {
	...
	@Override
	public SSKBlock construct(byte[] data, byte[] headers, byte[] routingKey, byte[] fullKey,
			boolean canReadClientCache, boolean canReadSlashdotCache, BlockMetadata meta,
			StoreDSAPublicKey knownPublicKey) throws SSKVerifyException {
	...
	public SSKBlock fetch(NodeSSK chk, boolean dontPromote, boolean canReadClientCache, boolean canReadSlashdotCache,
