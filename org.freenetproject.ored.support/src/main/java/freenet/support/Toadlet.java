...
public class Toadlet {
	...
	public static class FProxy {
		...
		/**
		 * Maximum size for transparent pass-through. See config
		...
		public static long MAX_LENGTH_NO_PROGRESS = (2 * 1024 * 1024) * 11 / 10; // 2MiB
																					// plus
																					// a
																					// bit
																					// due
	...
	public static class ExternalLink {
		...
		/**
		 * Prepends a given URI with the path and parameter names to get this external
