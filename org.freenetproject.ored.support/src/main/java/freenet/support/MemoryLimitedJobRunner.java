...
/**
 * Start jobs as long as there is sufficient memory (or other limited resource) available,
 * then queue them. FIXME I bet there is something like this in the standard libraries?
 *
 * @author toad
 */
public class MemoryLimitedJobRunner {
	...
	/**
	 * The jobs we can't start yet. FIXME Always FIFO order? Small jobs first? Prioritised
	 * even?
	 */
	...
	/**
	 * Run the job if the counter is below some threshold, otherwise queue it. Will ignore
	 * if shutting down.
	 */
