...
/**
 * Identifies a request and its client. Stable serialization format - must not change
 * without version bump, must maintain back compatibility within reason. This is initially
 * used to check for whether we've already loaded a request, but it will also be used for
 * last-resort restarting a request when serialization has failed.
 *
 * @author toad
 */
