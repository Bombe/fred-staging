...
public final class ClientConstants {
	...
	// For scaling purposes, 128 data 128 check blocks i.e. one check block per data
	// block.
	 ...
	 * FECCodec.standardOnionCheckBlocks will automatically reduce check blocks to
	 * compensate for more than half data blocks.
	 */
