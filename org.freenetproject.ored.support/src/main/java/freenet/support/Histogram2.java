...
/**
 * Similiar to a standard histogram, but each bar is reasoned independently. Pretty much
 * just an array of running averages. Used for tracking success rates per-location.
 */
