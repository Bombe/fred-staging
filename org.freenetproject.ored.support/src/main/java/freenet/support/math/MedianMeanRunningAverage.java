...
/**
 * A RunningAverage that tracks both the median and mean of a series of values. WARNING:
 * Uses memory and proportional to the number of reports! Only for debugging! (Also uses
 * CPU time O(N log N) with the number of reports in currentValue()).
 *
