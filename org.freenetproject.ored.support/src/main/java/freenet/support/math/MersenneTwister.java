...
/**
 ** This is a synchronized wrapper around
 * {@link org.spaceroots.mantissa.random.MersenneTwister} which also adds additional
 * {@code setSeed()} methods.
 **
 ** @author infinity0
 */
public class MersenneTwister extends org.spaceroots.mantissa.random.MersenneTwister {
	 ...
	 ** <p>
	 * The state of the generator is exactly the same as a new generator built with the
	 * same seed.
	 * </p>
	 ** @param seed the initial seed (8 bits byte array), if null the seed of the generator
