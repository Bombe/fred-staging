...
public interface UserAlert {
	...
	/**
	 * *Really* concise text of alert. Should be comfortably under a line even when
	 * translated into a verbose language. Will link to the full details.
	 */
	...
	/**
	 * Is the alert valid right now? Suggested use is to synchronize on the alert, then
	 * check this, then get the data.
	 */
	...
	/**
	 * @return A unique, short name for the alert. Can be simply hashCode(), not visible
	 * to the user. MUST NOT contain spaces or commas.
	 */
	public String anchor();

	/**
	 * @return True if this is an event notification. Event notifications can be bulk
	 * deleted. Eventually they will be handled differently - logged to a separate event
	 * log, and only the last few displayed on the homepage.
	 */
