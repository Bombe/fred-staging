...
/**
 * A class that takes logging messages and distributes them to LoggerHooks. It implements
 * LoggerHook itself, so that instances can be chained (just don't create loops).
 */
public class LoggerHookChain extends LoggerHook {
	...
	/**
	 * This is the implementation of LoggerHook method, which allows one logger receive
	 * events from another.
