...
public final class UTFUtil extends TestCase {
	...
	/**
	 * Contains all unicode characters except the low and high surrogates (they are no
	 * valid characters and constructing strings with them will cause the JRE to replace
	 * them with the default replacement character). Even 0x0000 is included.
	 */
	...
	/*
	 * HTML entities ISO-88591 see for reference
