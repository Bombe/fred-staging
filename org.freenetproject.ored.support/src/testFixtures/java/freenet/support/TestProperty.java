...
final public class TestProperty {
	...
	static {
		try {
			L10nPath_test = System.getProperty("test.l10npath_test", Path.of(TestProperty.class.getResource("/test/freenet.l10n.en.override.properties").toURI()).getParent().toString());
