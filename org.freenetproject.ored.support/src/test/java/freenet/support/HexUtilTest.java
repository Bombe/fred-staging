...
public class HexUtilTest extends TestCase {
	...
	public void testBytesToHex_byte() {
		...
		for (int i = 255; i >= 0; i--) {
			 ...
			 * hex. For this reason we need the next "switch case".
			 */
	...
	/**
	 * Test the hexToBytes(String) method against the hex representation of every possible
	 * single byte. The starting offset is always 0.
	 */
	...
	/**
	 * Test the hexToBytes(String,int) method against the hex representation of every
	 * possible single byte. The starting offset is always 0.
	 */
	...
	/**
	 * Test the hexToBytes(String,byte[],int) method against the hex representation of
	...
	/**
	 * Test the bitsToByte(BitSet,int) method against the bit representation of every
	 * possible single byte.
	 */
	...
	/**
	 * Test bytesToBits(byte[],BitSet,int) method against all possible single byte value.
	 * It uses HexUtil.bitsToBytes() method for the check, so be sure that method works
	 * correctly!
	 */
	...
	/**
	 * Test biToHex(BigInteger) method comparing its results to results provided by
	 * different scientific valid calculators.
	 */
	...
	/**
	 * Test bitsToHexString(BitSet,int) method comparing its results to results provided
	...
	/**
	 * Tests writeBigInteger(BigInteger,DataOutputStream) and
	 * readBigInteger(DataInputStream) comparing a BigInteger after writing it to a Stream
	 * and reading it from the writing result.
	 */
	public void testWriteAndReadBigInteger() {
		...
		try {
			...
			ByteArrayInputStream methodByteArrayInStream = new ByteArrayInputStream(
					methodByteArrayOutStream.toByteArray());
	...
	/**
	 * Test bytesToHex(byte[],int,int) method with a too long starting offset. The tested
	...
	/**
	 * Test bytesToHex(byte[],int,int) method with asking to read too many bytes. The
	 * tested method should raise an exception.
	 */
	...
	/**
	 * Test hexToBytes(String,byte[],int) method with a too long offset. The method should
	 * raise an exception.
	 */
	...
	/**
	 * Test hexToBytes(String,byte[],int) method with a too short byte[] to put the
	 * result. The method should raise an exception.
	 */
	...
	/**
	 * Test all hexToBytes() methods with a not valid character. The method should raise
	 * an exception.
	 */
	...
	/**
	 * Test the bitsToByte(BitSet,int) method using a size smaller than the actual number
	...
	/*
	 * Checks that offset == array length is allowed, which is needed for handling zero
	 * length arrays
	 */
