...
public class HTMLEncoderDecoderTest extends TestCase {
	...
	/**
	 * Tests decode(String) method trying to decode a long String with all possible entity
	 * appended
	 */
	...
	/**
	 * Tests decode(String) method trying to decode incomplete entities. The incomplete
	 * entity must remain the same as before encoding
	 */
	...
	/**
	 * Tests compact(String) method trying to compact String with repeated whitespaces of
	 * every kind (e.g. tabs,newline,space).
	 */
