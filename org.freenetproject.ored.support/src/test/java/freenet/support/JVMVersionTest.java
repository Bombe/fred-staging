...
public class JVMVersionTest extends TestCase {
	...
	public void testRelative() {
		/*
		 * Being at too old a version for the modern updater URI must produce a warning,
		 * but a warning can be shown for a version not yet too old for the modern updater
		 * URI.
		 */
	...
	public void testCompare() {
		String[] orderedVersions = new String[] { "bogus", // Bogus versions are treated
															// as 0.0.0_0
				"1.5", "1.6.0", "1.6.0_32", "1.7", "1.7.0_59", "1.7.0_65", "1.7.1", "1.7.1_1", "1.7.1_09",
				"1.7.1_65-rc4", "1.7.2-ea", "1.7.3_0", "1.8-beta", "9-ea", "9.0.1.0", "9.0.1.1.0.1-ea", "9.2", "10",
				"10.0.2" };
