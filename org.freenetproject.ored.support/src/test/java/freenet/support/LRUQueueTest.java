...
public class LRUQueueTest extends TestCase {
	...
	/**
	 * Tests {@link LRUQueue#push(Object)} method providing a null object as argument
	 * (after setting up a sample queue) and verifying if the correct exception is raised
	 */
	...
	/**
	 * Tests {@link LRUQueue#push(Object)} method and verifies the behaviour when pushing
	...
	/**
	 * Tests{@link LRUQueue#pop()} method pushing and popping objects and verifying if
	...
	/**
	 * Tests {@link LRUQueue#size()} method checking size when empty, when putting each
	 * object and when popping each object.
	 */
	...
	/**
	 * Tests {@link LRUQueue#remove(Object)} method verifies if all objects are correctly
	 * removed checking the method return value, if the object is still contained and the
	 * queue size.
	 */
	...
	/**
	 * Tests{@link LRUQueue#remove(Object)} providing a null argument and trying to remove
	 * it after setting up a sample queue.
	 */
	...
	/**
	 * Tests {@link LRUQueue#remove(Object)} method trying to remove a not present object
	...
	/**
	 * Tests {@link LRUQueue#contains(Object)} method trying to find a not present object
	 * after setting up a sample queue. Then it search a present object.
	 */
	...
	/**
	 * Tests {@link LRUQueue#elements()} method verifying if the Enumeration provided is
	 * correct
	 */
	...
	/**
	 * Tests {@link LRUQueue#toArray()} method verifying if the array generated has the
	 * same object that are put into the created LRUQueue
	 */
