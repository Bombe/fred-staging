...
/**
 * Test case for {@link freenet.support.URLEncoder} and {@link freenet.support.URLDecoder}
 * classes.
 *
...
public class URLEncoderDecoderTest extends TestCase {
	...
	/**
	 * Encodes a string of ALL unicode characters except the 0-character and tests whether
	...
	/**
	 * Tests if URLEncode.encode(String) and URLDecode.decode(String,boolean) methods work
	 * correctly together, both with safe characters and not safe "base" (i.e. ASCII)
	 * chars .
	 */
	...
	/**
	 * Tests if URLEncode.encode(String) and URLDecode.decode(String,boolean) methods work
	 * correctly together, both with safe characters and not safe "advanced" (i.e. not
	 * ASCII) chars .
	 */
	...
	/**
	 * Verifies if a string is the same after being processed by encoding and decoding
	 * methods
	...
	/**
	 * Tests encode(String,String,boolean) method to verify if the force parameter is
	 * well-managed for each safeURLCharacter, with both true and false ascii-flag.
	 */
	...
	/**
	 * Tests decode(String,boolean) method using not valid encoded String to verifies if
	...
	/**
	 * Tests decode(String,boolean) method using not valid hex values String to verifies
	...
	/**
	 * Tests decode(String,boolean) method trying the boolean argument, to verify if it
	 * work correctly as a hack to allow users to paste in URLs containing %'s.
	 */
	...
	/**
	 * Tests whether all URL-encoded characters are acceptable to the java.net.URI
	 * constructor.
	 */
