...
public class PrioritizedTickerTest extends TestCase {
	...
	private class MyTicker extends PrioritizedTicker {
		...
		public void waitForIdle() throws InterruptedException {
			...
			// Wait until the jobs have actually been started off thread or completed on
			// thread.
			waitForSleeping();
		}
	...
	private enum BlockTickerJobState {
		...
		WAITING, BLOCKING, FINISHED

	}

	/**
	 * Allows us to block the Ticker. Because it's a FastRunnable it will be run directly
	 * on the Ticker thread itself. But it's not actually fast - it waits!
	 */
