...
public class BitInputStreamTest {
	...
	public void unalignedBytesTest() throws IOException {
		String bitData = "0101 00001 00001 00010 00011 00101 01000 01101 10101" // 5: 1,
																				// 1, 2,
																				// 3, 5,
																				// 8, 13,
																				// 21
				+ "0011 000 001 010 011 100 101 110" // 3: 0, 1, 2, 3, 4, 5, 6
				+ "101 11 111 1110 00100 00"; // 5, 3, 7, 14, 4, plus two additional bits
												// for align data
	...
	/*
	 * Testing algorithm: 1. Read a 4-bit unsigned integer. Assign nBits the value read 2.
	 * For each consecutive value of qi from 0 to n, exclusive: (a) Read an nBits-bit
	 * unsigned integer as nmbrs[qi].
	 */
