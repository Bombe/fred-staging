...
public class TimeUtilTest extends TestCase {
	...
	/**
	 * Tests formatTime(long) method using known values. They could be checked using
	...
	/**
	 * Tests formatTime(long,int) method using a long value that generate every possible
	 * term kind. It tests if the maxTerms arguments works correctly
	 */
	...
	/**
	 * Tests formatTime(long,int) method using one millisecond time interval. It tests if
	 * the withSecondFractions argument works correctly
	 */
