...
public class LRUMapTest extends TestCase {
	...
	/**
	 * Creates a double array of objects with a specified size where Object[i][0] is the
	 * key, and is an Integer, and Object[i][1] is the value
	 ...
	 * @return true if the key is present and returned value is the same as in the
	 * argument
	 */
	...
	/**
	 * Tests push(Object,Object) method providing null object as arguments (after setting
	 * up a sample HashTable) and verifying if the correct exception is raised
	 */
	...
	/**
	 * Tests push(Object,Object) method and verifies the behaviour when pushing the same
	 * object more than one time.
	 */
	public void testPushSameObjTwice() {
		LRUMap<Object, Object> methodLRUht = createSampleHashTable(sampleElemsNumber);
		Object[][] sampleObj = { { sampleElemsNumber, new Object() }, { sampleElemsNumber + 1, new Object() } };
	...
	/**
	 * Tests popKey() method pushing and popping objects and verifying if their keys are
	 * correctly (in a FIFO manner) fetched and the HashTable entry deleted
	 */
	...
	/**
	 * Tests popValue() method pushing and popping objects and verifying if their values
	 * are correctly (in a FIFO manner) fetched and the HashTable entry deleted
	 */
	...
	/**
	 * Tests peekValue() method pushing and popping objects and verifying if their
	 * peekValue is correct
	 */
	...
	/**
	 * Tests removeKey(Object) method verifies if all elements are correctly removed
	 * checking the method return value, if the element is still contained and the
	 * HashTable size.
	 */
	...
	/**
	 * Tests removeKey(Object) providing a null key and trying to remove it after setting
	 * up a sample queue.
	 */
	...
	/**
	 * Tests removeKey(Object) method trying to remove a not present key after setting up
	 * a sample LRUMap.
	 */
	...
	/**
	 * Tests containsKey(Object) method trying to find a not present key after setting up
	 * a sample queue. Then it search for a present one.
	 */
	...
	/**
	 * Tests get(Object) method trying to find a not present key after setting up a sample
	 * HashTable, then it search a present key.
	 */
	public void testGet() {
		LRUMap<Object, Object> methodLRUht = createSampleHashTable(sampleElemsNumber);
	...
	/**
	 * Tests isEmpty() method trying it with a new generated HashTable and after popping
