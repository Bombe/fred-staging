...
public class BitArrayTest extends TestCase {
	...
	/**
	 * Tests BitArray(int) constructor and verifies if the instance is well created (all
	 * values must be readables and false, and the length has to be correct)
	 */
	...
	/**
	 * Tests unsignedByteToInt(byte) method trying it correctness for every possible (i.e.
	 * 256) byte value
	 */
	...
	/**
	 * Tests setAllOnes() method comparing the result to a BitArray with already all ones
	 * set.
	 */
	...
	/**
	 * Tests firstOne() method far all possible first-one-position in a BitArray with as
	 * many bits as in a single byte
	 */
