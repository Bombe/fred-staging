...
public class MultiValueTableTest extends TestCase {
	...
	/**
	 * Create a Object[][] filled with increasing Integers as keys and a List of generic
	 * Objects as values.
	 * @param keysNumber the number of keys to create
	 * @param valueNumber the maximum value number per key
	 * @param isRandom if true each key could have [1,valuesNumber] values chosen
	 * randomly, if false each key will have valuesNumber values
	 ...
	 * @param isRandom true if the maxValueNumber is an upper bound, false if it is the
	 * actual value
	 * @return the sample MultiValueTable created
	 */
	private MultiValueTable<Object, Object> createSampleMultiValueTable(int keyNumber, int maxValueNumber,
			boolean isRandom) {
	...
	/**
	 * Fill a new MultiValueTable from a Object[][] provided. The Object[][] must be in
	 * the same form generated by createSampleKeyMultiVal method.
	 * @param sampleObjects Object[][] array, with [i][0] as key and [i][1] as list of
	 * values
	...
	/**
	 * Tests containsKey(Object) method verifying if all keys inserted are correctly
	 * found. It verifies the correct behavior with empty MultiValueTable and not present
	 * keys, too.
	 */
	...
	/**
	 * Tests containsElement(Object,Object) method verifying if all values inserted are
	 * correctly found. It verifies the correct behavior with empty MultiValueTable and
	 * not present Elements, too.
	 */
	@SuppressWarnings("unchecked")
	...
	/**
	 * Tests remove(Object) method trying to remove all keys inserted in a
	 * MultiValueTable. It verifies the behavior when removing a not present key, too.
	 */
	...
	/**
	 * Tests isEmpty() method with an empty MultiValueTable, after putting objects and
	 * after removing all of them.
	 */
	...
	/**
	 * Tests clear() method filling a MultiValueTable and verifying if all keys are
	 * correctly removed. Finally it verifies the result of isEmpty() method.
	 */
	...
	/**
	 * Tests removeElement(Object,Object) removing all elements from a sample
	 * MultiValueTable, and verifying if they are correctly removed and if the result of
	 * isEmpty() method is correct.
	 */
	@SuppressWarnings("unchecked")
	...
	/**
	 * Tests keys() method verifying if all keys inserted are correctly present in the
	...
	/**
	 * Tests elements() and keys() method verifying their behavior when putting the same
