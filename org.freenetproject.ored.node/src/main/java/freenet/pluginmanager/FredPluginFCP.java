...
/**
 * Interface that has to be implemented for plugins that want to be talkable via fcp or
 * direct (plugin to plugin)
 *
...
public interface FredPluginFCP {
	 ...
	 * @param accesstype 0: direct call (plugin to plugin), 1: FCP restricted access, 2:
	 * FCP full access
