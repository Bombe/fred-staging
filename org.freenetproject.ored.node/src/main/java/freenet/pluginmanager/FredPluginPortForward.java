...
public interface FredPluginPortForward {
	 ...
	 * @param ports The set of ports that need to be forwarded from the outside world
	 * through the NAT or firewall.
	 * @param cb Callback to be called with success/failure of each forward. Some plugins
	 * may return a probabilistic success e.g. with UP&P.
	 */
