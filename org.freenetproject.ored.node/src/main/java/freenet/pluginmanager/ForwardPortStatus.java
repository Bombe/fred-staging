...
public class ForwardPortStatus {
	...
	/**
	 * The port forward probably succeeded. I.e. it succeeded unless there was for example
	 * hostile action on the part of the router.
	 */
	public static final int PROBABLE_SUCCESS = 2;

	/**
	 * The port forward may have succeeded. Or it may not have. We should definitely try
	 * to check out of band. See UP&P: Many routers say they've forwarded the port when
	 * they haven't.
	 */
	...
	/**
	 * Some plugins may need to change the external port. They can return it to the node
	 * here.
	 */
