...
public class PluginReplySenderFCP extends PluginReplySender {
	 ...
	 */
	public PluginReplySenderFCP(FCPConnectionHandler handler2, String pluginname2, String clientIdentifier,
	...
	public void send(SimpleFieldSet params, Bucket bucket) throws PluginNotFoundException {
		// like in linux everthing is a file, in Plugintalker everything is a plugin. So
		// it throws PluginNotFoundException
