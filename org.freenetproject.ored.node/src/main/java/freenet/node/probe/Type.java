...
public enum Type {
	...
	BANDWIDTH((byte) 0), BUILD((byte) 1), IDENTIFIER((byte) 2), LINK_LENGTHS((byte) 3), LOCATION((byte) 4), STORE_SIZE(
			(byte) 5), UPTIME_48H((byte) 6), UPTIME_7D(
					(byte) 7), REJECT_STATS((byte) 8), OVERALL_BULK_OUTPUT_CAPACITY_USAGE((byte) 9);
