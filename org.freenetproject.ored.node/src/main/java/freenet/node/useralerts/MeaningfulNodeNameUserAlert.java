...
import freenet.clients.http.ToadletConfigOptionAdapter;
...
public class MeaningfulNodeNameUserAlert extends BaseNodeUserAlert {

	private final Node node;

	public MeaningfulNodeNameUserAlert(Node n) {
		super(true, null, null, null, null, FCPUserAlert.WARNING, true, NodeL10n.getBase().getString("UserAlert.hide"),
				true, null);
		this.node = n;
	}
	...
	public HTMLNode getHTMLText() {
		...
		HTMLNode formNode = alertNode.addChild("form", new String[] { "action", "method" },
		...
		itemNode.addChild("span", new String[] { "class", "title", "style" },
				new String[] { "configshortdesc",
						...
						"cursor: help;" })
				.addChild(new ToadletConfigOptionAdapter<>(o).getShortDescNode());
		itemNode.addChild("input", new String[] { "type", "class", "alt", "name", "value" },
				new String[] { "text", "config", o.getShortDesc(), "node.name", o.getValueDisplayString() });
		itemNode.addChild("span", "class", "configlongdesc")
				.addChild(new ToadletConfigOptionAdapter<>(o).getLongDescNode());
