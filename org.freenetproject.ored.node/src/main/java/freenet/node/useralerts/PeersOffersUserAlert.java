...
public class PeersOffersUserAlert extends BaseNodeUserAlert {
	...
	public HTMLNode getHTMLText() {
		...
		HTMLNode form = content.addChild("form", new String[] { "action", "method" },
		...
		form.addChild("input", new String[] { "type", "name", "value" }, new String[] { "submit", "add", "Connect" });
