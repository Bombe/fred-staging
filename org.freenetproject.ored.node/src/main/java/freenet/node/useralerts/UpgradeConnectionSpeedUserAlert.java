...
public class UpgradeConnectionSpeedUserAlert extends BaseNodeUserAlert {
	...
	public HTMLNode getHTMLText() {
		...
		content.addChild("p",
				l10n("text", new String[] { "input", "output" },
						new String[] { SizeUtil.formatSize(node.config.get("node").getInt("inputBandwidthLimit")),
