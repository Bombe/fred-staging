...
public class MeaningfulNodeNameUserAlert extends BaseNodeUserAlert {
	...
	public MeaningfulNodeNameUserAlert(Node n) {
		super(true, null, null, null, null, FCPUserAlert.WARNING, true, NodeL10n.getBase().getString("UserAlert.hide"), true, null);
		this.node = n;
	}
	...
	public HTMLNode getHTMLText() {
		...
		itemNode.addChild("span", new String[]{ "class", "title", "style" },
				...
				"cursor: help;" }).addChild(new ToadletConfigOptionAdapter<>(o).getShortDescNode());
		...
		itemNode.addChild("span", "class", "configlongdesc").addChild(new ToadletConfigOptionAdapter<>(o).getLongDescNode());
