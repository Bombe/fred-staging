...
import freenet.nodeapp.useralerts.IPUndetectedUserAlert;
import freenet.nodeapp.useralerts.InvalidAddressOverrideUserAlert;
		...
		if(ipDetectorManager != null && ipDetectorManager.isEmpty()) {
			if(maybeSymmetricAlert == null) {
				maybeSymmetricAlert = new SimpleUserAlert(true, l10n("maybeSymmetricTitle"), 
						l10n("maybeSymmetric"), l10n("maybeSymmetricShort"), FCPUserAlert.ERROR);
			}
