...
import freenet.nodeapp.useralerts.BaseNodeUserEvent;
import freenet.nodeapp.useralerts.SimpleUserAlert;
import freenet.nodeapp.useralerts.UserEvent;
...
public class Announcer {
	...
	private SimpleUserAlert announcementDisabledAlert =
		new SimpleUserAlert(false, l10n("announceDisabledTooOldTitle"), l10n("announceDisabledTooOld"), l10n("announceDisabledTooOldShort"), FCPUserAlert.CRITICAL_ERROR) {
