package freenet.nodeapp.updater;
...
public class MainJarUpdater extends NodeUpdater implements MainJarDependenciesChecker.Deployer {
	...
	/** Glue code. */
	private class DependencyJarFetcher implements MainJarDependenciesChecker.JarFetcher, ClientGetCallback, RequestClient, ClientEventListener {
		...
		DependencyJarFetcher(File filename, FreenetURI chk, long expectedLength, byte[] expectedHash, MainJarDependenciesChecker.JarFetcherCallback cb, boolean essential, boolean executable) throws FetchException {
			...
			getter = new ClientGetter(this,  
					chk, myCtx, PriorityClasses.IMMEDIATE_SPLITFILE_PRIORITY_CLASS,
	...
	@Override
	public MainJarDependenciesChecker.JarFetcher fetch(FreenetURI uri, File downloadTo,
                                                       long expectedLength, byte[] expectedHash, MainJarDependenciesChecker.JarFetcherCallback cb, int build, boolean essential, boolean executable) throws FetchException {
		if(essential)
