...
import freenet.nodeapp.NodeStats;
import freenet.nodeapp.OpennetManager;
import freenet.nodeapp.PeerManager;
import freenet.nodeapp.PeerNodeStatus;
import freenet.nodeapp.RequestTracker;
import freenet.nodeapp.Version;
import freenet.nodeapp.diagnostics.ThreadDiagnostics;
import freenet.nodeapp.diagnostics.threads.NodeThreadInfo;
import freenet.nodeapp.diagnostics.threads.NodeThreadSnapshot;
...
public class DiagnosticToadlet extends Toadlet {
	...
	protected DiagnosticToadlet(Node n, NodeClientCore core, FCPServer fcp, HighLevelSimpleClient client) {
		...
		baseL10n = new BaseL10n("/l10n/", "freenet.l10n.${lang}.properties", new File(".").getPath()+File.separator+"freenet.l10n.${lang}.override.properties", BaseL10n.LANGUAGE.ENGLISH);
	}
