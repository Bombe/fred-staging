...
public class BookmarkItem extends Bookmark {
	...
	public BookmarkItem(FreenetURI k, String n, String d, String s, boolean hasAnActivelink, BookmarkManager bm,
	...
	public BookmarkItem(SimpleFieldSet sfs, BookmarkManager bm, UserAlertManager uam)
		...
		// "Updated" was added in 2016-08-19, so we must assume it doesn't exist in
		// previously saved
	...
	private class BookmarkUpdatedUserAlert extends BaseNodeUserAlert {

		public BookmarkUpdatedUserAlert() {
			super(true, null, null, null, null, FCPUserAlert.MINOR, false, null, true, null);
		}
		...
		public HTMLNode getHTMLText() {
			...
			NodeL10n.getBase().addL10nSubstitution(n, "BookmarkItem.bookmarkUpdatedWithLink",
					new String[] { "link", "name", "edition" }, new HTMLNode[] { HTMLNode.link("/" + key),
							HTMLNode.text(name), HTMLNode.text(key.getSuggestedEdition()) });
			return n;
		}
	...
	/**
	 * If this bookmark is marked as updated, registers a {@link FCPUserAlert} which
	 * notifies the user. You usually only need to call this function after having loaded
	 * a bookmark from disk using
	...
	public FCPUserAlert getUserAlert() {
		return alert;
	}
	...
	public String getShortDescription() {
		...
		if (shortDescription.toLowerCase().startsWith("l10n:"))
			return NodeL10n.getBase()
					.getString("Bookmarks.Defaults.ShortDescription." + shortDescription.substring("l10n:".length()));
