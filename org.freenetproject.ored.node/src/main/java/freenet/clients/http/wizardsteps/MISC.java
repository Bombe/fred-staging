...
/**
 * Allows the user to choose whether to enable auto-updating, and what official utility
 * plugins to install.
 */
public class MISC implements Step {
	...
	public void getStep(HTTPRequest request, PageHelper helper) {
		...
		HTMLNode miscInfoboxContent = helper.getInfobox("infobox-normal", WizardL10n.l10n("autoUpdate"), form, null,
				false);

		miscInfoboxContent.addChild("p", WizardL10n.l10n("autoUpdateLong"));
		miscInfoboxContent.addChild("p")
				.addChild("input", new String[] { "type", "checked", "name", "value", "id" },
						new String[] { "radio", "on", "autodeploy", "true", "autodeployTrue" })
				.addChild("label", new String[] { "for" }, new String[] { "autodeployTrue" },
						WizardL10n.l10n("autoUpdateAutodeploy"));
		miscInfoboxContent.addChild("p")
				.addChild("input", new String[] { "type", "name", "value", "id" },
						new String[] { "radio", "autodeploy", "false", "autodeployFalse" })
				.addChild("label", new String[] { "for" }, new String[] { "autodeployFalse" },
		...
		miscInfoboxContent.addChild("p")
				...
				.addChild("label", new String[] { "for" }, new String[] { "upnpTrue" }, WizardL10n.l10n("enableUPnP"));
		miscInfoboxContent.addChild("input", new String[] { "type", "name", "value" },
	...
	/**
	 * Enables or disables the UPnP plugin asynchronously. If the plugin's state would not
	 * change for the given argument, it does nothing.
