...
/**
 * Asks the user whether their connection has a monthly cap to inform how to prompt for
 * bandwidth limits.
 */
public class BANDWIDTH implements Step {
	...
	public void getStep(HTTPRequest request, PageHelper helper) {
		...
		bandwidthForm.addChild("input", new String[] { "type", "name", "value" },
				new String[] { "submit", "yes", NodeL10n.getBase().getString("Toadlet.yes") });
		bandwidthForm.addChild("input", new String[] { "type", "name", "value" },
				new String[] { "submit", "no", NodeL10n.getBase().getString("Toadlet.no") });
		bandwidthForm.addChild("div").addChild("input", new String[] { "type", "name", "value" },
