...
/**
 * This step is the first, and provides a small welcome screen and an option to change the
 * language.
 */
public class WELCOME implements Step {
	 ...
	 * @param config Node config; cannot be null. Used to build language drop-down and
	 * change language.
	 */
	 ...
	 * @param request used to check whether the user is using a browser with incognito
	 * mode.
	 */
	@Override
	...
	public String postStep(HTTPRequest request) {
		// The user changed their language on the welcome page. Change the language and
		// re-render the page.
		// Presets are handled within FirstTimeWizardToadlet because it can access all
		// steps.
