...
public class ExternalLinkToadlet extends Toadlet {
	...
	public void handleMethodPOST(URI uri, HTTPRequest request, ToadletContext ctx)
		...
		// TODO: This will mean the beginning of the first time wizard if it's still in
		// progress.
	...
	public void handleMethodGET(URI uri, HTTPRequest request, ToadletContext ctx)
		...
		HTMLNode warnboxContent = ctx.getPageMaker().getInfobox("infobox-warning", l10n("confirmExternalLinkSubTitle"),
				contentNode, "confirm-external-link", true);
		...
		externalLinkForm.addChild("input", new String[] { "type", "name", "value" },
	...
	/**
	 * Prepends a given URI with the path and parameter names to get this external link
	 * confirmation page.
