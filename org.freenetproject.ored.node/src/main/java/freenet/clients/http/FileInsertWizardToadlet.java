...
public class FileInsertWizardToadlet extends Toadlet implements LinkEnabledCallback {
	...
	private HTMLNode createInsertBox(PageMaker pageMaker, ToadletContext ctx, boolean isAdvancedModeEnabled) {
		/* the insert file box */
		InfoboxNode infobox = pageMaker.getInfobox(NodeL10n.getBase().getString("QueueToadlet.insertFile"),
				"insert-queue", true);
		...
		HTMLNode input = insertForm.addChild("input", new String[] { "type", "name", "value", "id" },
		...
		insertForm.addChild("label", new String[] { "for" }, new String[] { "keytypeChk" }).addChild("b",
		...
		input = insertForm.addChild("input", new String[] { "type", "name", "value", "id" },
				new String[] { "radio", "keytype", "SSK", "keytypeSsk" });
		if (seclevel == NETWORK_THREAT_LEVEL.MAXIMUM || (rememberedLastTime && !wasCanonicalLastTime)) {
			input.addAttribute("checked", "checked");
		}
		insertForm.addChild("label", new String[] { "for" }, new String[] { "keytypeSsk" }).addChild("b",
		...
		if (isAdvancedModeEnabled) {
			insertForm.addChild("br");
			insertForm.addChild("input", new String[] { "type", "name", "value", "id" },
					new String[] { "radio", "keytype", "specify", "keytypeSpecify" });
			insertForm.addChild("label", new String[] { "for" }, new String[] { "keytypeSpecify" }).addChild("b",
					l10n("insertSpecificKeyTitle"));
			insertForm.addChild("#", ": " + l10n("insertSpecificKey") + " ");
			insertForm.addChild("input", new String[] { "type", "name", "value" },
					new String[] { "text", "key", "KSK@" });
		}
		if (isAdvancedModeEnabled) {
			insertForm.addChild("br");
			insertForm.addChild("br");
			insertForm.addChild("input", new String[] { "type", "name", "checked", "id" },
					new String[] { "checkbox", "compress", "checked", "checkboxCompress" });
			insertForm.addChild("label", new String[] { "for" }, new String[] { "checkboxCompress" },
		...
		if (isAdvancedModeEnabled) {
			...
			insertForm.addChild("input", new String[] { "type", "name", "maxlength" },
		...
		if (ctx.isAllowedFullAccess()) {
			...
			insertForm.addChild("input", new String[] { "type", "name", "value" }, new String[] { "submit",
					"insert-local", NodeL10n.getBase().getString("QueueToadlet.insertFileBrowseButton") + "..." });
			insertForm.addChild("br");
		}
		...
		insertForm.addChild("#", " \u00a0 ");
		insertForm.addChild("input", new String[] { "type", "name", "value" }, new String[] { "submit", "insert",
	...
	private HTMLNode createFilterBox(PageMaker pageMaker, ToadletContext ctx) {
		...
		insertForm.addChild("label", new String[] { "for" }, new String[] { "resHandlingDisplay" },
		...
		insertForm.addChild("label", new String[] { "for" }, new String[] { "resHandlingSave" },
		...
		if (ctx.isAllowedFullAccess()) {
			insertForm.addChild("#", NodeL10n.getBase().getString("QueueToadlet.insertFileBrowseLabel") + ": ");
			insertForm.addChild("input", new String[] { "type", "name", "value" }, new String[] { "submit",
					"filter-local", NodeL10n.getBase().getString("QueueToadlet.insertFileBrowseButton") + "..." });
			insertForm.addChild("br");
		}
		insertForm.addChild("#", NodeL10n.getBase().getString("QueueToadlet.insertFileLabel") + ": ");
		insertForm.addChild("input", new String[] { "type", "name", "value" }, new String[] { "file", "filename", "" });
		...
		insertForm.addChild("input", new String[] { "type", "name", "value" },
				new String[] { "submit", "filter-upload", ContentFilterToadlet.l10n("filterFileFilterLabel") });
		return insertBox;
	}
