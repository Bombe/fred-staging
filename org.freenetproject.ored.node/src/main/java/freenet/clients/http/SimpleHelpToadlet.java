...
/**
 * Simple Help Toadlet. Provides an offline means of looking up some basic info, howtos,
 * and FAQ Likely to be superceded someday by an offical Freesite and binary blob included
 * in install package.
 *
 * @author Juiceman
 */
public class SimpleHelpToadlet extends Toadlet {
	...
	public void handleMethodGET(URI uri, HTTPRequest request, ToadletContext ctx)
		...
		PageNode page = ctx.getPageMaker().getPageNode("Freenet " + NodeL10n.getBase().getString("FProxyToadlet.help"),
				ctx);
		...
		HTMLNode helpScreenContent1 = ctx.getPageMaker().getInfobox("infobox-content",
				NodeL10n.getBase().getString("SimpleHelpToadlet.descriptionTitle"), contentNode, "freenet-description",
				true);
		...
		HTMLNode helpScreenContent2 = ctx.getPageMaker().getInfobox("infobox-content",
				NodeL10n.getBase().getString("SimpleHelpToadlet.definitionsTitle"), contentNode, "freenet-definitions",
				true);

		HTMLNode table = helpScreenContent2.addChild("table", new String[] { "border", "style" },
