...
/**
 * This Node displays a timer with a text, and the timer is ascending/decreasing every
 * second at the client-side if Javascript is enabled.
 */
public class SecondCounterNode extends HTMLNode {
	...
	public SecondCounterNode(long initialValue, boolean ascending, String text) {
		...
		// If the text has {0}, then it will be replaced by the time. This way text can be
		// present both before and after the counter
