...
public class PeerVisibilityInputForAddPeerBoxNode extends HTMLNode {
	...
	public PeerVisibilityInputForAddPeerBoxNode() {
		...
		for (DarknetPeerNode.FRIEND_VISIBILITY visibility : DarknetPeerNode.FRIEND_VISIBILITY.values()) { // FIXME
																											// reverse
																											// order
			...
			input.addChild("label", new String[] { "for" }, new String[] { "visibility" + visibility.name() })
