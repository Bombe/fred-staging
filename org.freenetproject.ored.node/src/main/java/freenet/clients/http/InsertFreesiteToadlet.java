...
public class InsertFreesiteToadlet extends Toadlet {
	...
	public void handleMethodGET(URI uri, HTTPRequest req, ToadletContext ctx)
		...
		HTMLNode contentBox = ctx.getPageMaker().getInfobox("infobox-information", l10n("title"), contentNode,
				"freesite-insert", true);

		contentBox.addChild("p", l10n("content1"));

		NodeL10n.getBase().addL10nSubstitution(contentBox.addChild("p"), "InsertFreesiteToadlet.contentFlogHelper",
				new String[] { "plugins" }, new HTMLNode[] { HTMLNode.link(PproxyToadlet.PATH) });
		...
		NodeL10n.getBase().addL10nSubstitution(contentBox.addChild("p"), "InsertFreesiteToadlet.content2",
				...
				new HTMLNode[] {
						...
						HTMLNode.text("0.14"), HTMLNode.link(
