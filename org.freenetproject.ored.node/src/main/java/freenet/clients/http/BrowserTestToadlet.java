...
public class BrowserTestToadlet extends Toadlet {
	...
	private final static String imgWarningMime = "R0lGODdh1AE8AOf9AAABAAcAAAkBAAoDARAAAQcECRYAAxoCAB4BACIBARMK"
			...
			+ "TTfltFP4CgA1VFFFraqAAAIANUIAYJzwRFRHhRVWT2eltVZbb8U1V1135bVX" + "X38FNlhhhyW2WGOPRTZZZbEMCAA7";

	public void handleMethodGET(URI uri, HTTPRequest request, ToadletContext ctx)
			throws ToadletContextClosedException, IOException {
		// Yes, we need that in order to test the browser (number of connections per
		// server)
		...
		// #### Test MIME inline
		/*
		 * for test (for allow <img src="data:...) add "; img-src 'self' data:" to
		 * freenet.clients.http.ToadletContextImpl#generateCSP return statement
		 */
		ctx.getPageMaker().getInfobox("infobox-warning", "MIME Inline", contentNode, "mime-inline-test", true).addChild(
				"img", new String[] { "src", "alt" },
				new String[] { "data:image/gif;base64," + imgWarningMime, "Your browser is probably safe." });
