...
public class UploadDirRequestStatus extends UploadRequestStatus {
	...
	public UploadDirRequestStatus(String identifier, Persistence persistence, boolean started, boolean finished,
			...
			Date latestFailure, boolean totalFinalized, short prio, FreenetURI finalURI, FreenetURI targetURI,
		...
		super(identifier, persistence, started, finished, success, total, min, fetched, latestSuccess, fatal, failed,
				latestFailure, totalFinalized, prio, finalURI, targetURI, failureCode, failureReasonShort,
				failureReasonLong);
