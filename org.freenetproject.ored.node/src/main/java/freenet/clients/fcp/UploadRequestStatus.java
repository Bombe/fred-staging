...
public abstract class UploadRequestStatus extends RequestStatus {
	...
	UploadRequestStatus(String identifier, Persistence persistence, boolean started, boolean finished, boolean success,
			...
			FreenetURI finalURI, FreenetURI targetURI, InsertExceptionMode failureCode, String failureReasonShort,
