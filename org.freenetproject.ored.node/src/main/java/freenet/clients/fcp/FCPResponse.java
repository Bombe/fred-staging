...
public abstract class FCPResponse extends FCPMessage {
	...
	/**
	 * @param fcpIdentifier FCP-level identifier for pairing requests and responses. If
	 * null the field is omitted.
	 */
	...
	public void run(FCPConnectionHandler handler, Node node) throws MessageInvalidException {
		throw new MessageInvalidException(ProtocolErrorMessage.INVALID_MESSAGE,
				getName() + " is a reply from the node; the client should not send it.", null, false);
	}
