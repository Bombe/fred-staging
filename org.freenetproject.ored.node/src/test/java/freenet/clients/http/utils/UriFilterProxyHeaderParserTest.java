...
public class UriFilterProxyHeaderParserTest {
	...
	public void standardValuesParsedAsStandardPrefix() throws Exception {
		testUriPrefixMatchesExpected("8888", "127.0.0.1", "", "",
	...
	public void emptyArgumentsParsedAsStandardPrefix() throws Exception {
		testUriPrefixMatchesExpected("", "", "", "", MultiValueTable.from(new String[] {}, new String[] {}),
				"http://127.0.0.1:8888");
	}

	@Test
	public void nullArgumentsParsedAsStandardPrefix() throws Exception {
		testUriPrefixMatchesExpected("", "", null, null, MultiValueTable.from(new String[] {}, new String[] {}),
				"http://127.0.0.1:8888");
	}
	...
	public void defaultPortParsedAsStandardPrefix() throws Exception {
		testUriPrefixMatchesExpected("8888", "", "", "", MultiValueTable.from(new String[] {}, new String[] {}),
				"http://127.0.0.1:8888");
	}

	@Test
	public void defaultIpParsedAsStandardPrefix() throws Exception {
		testUriPrefixMatchesExpected("", "127.0.0.1", "", "", MultiValueTable.from(new String[] {}, new String[] {}),
				"http://127.0.0.1:8888");
	}
	...
	public void allowedProxyHostIsUsedIfInSecondPositionOfBindTo() throws Exception {
		testUriPrefixMatchesExpected("8888", "127.0.0.1,foo", "", "",
				MultiValueTable.from(new String[] { "x-forwarded-host" }, new String[] { "foo" }), "http://foo");
	}

	@Test
	public void allowedProxyHostIsUsedIfInFirstPositionOfBindTo() throws Exception {
		testUriPrefixMatchesExpected("8888", "foo,127.0.0.1", "", "",
	...
	public void allowedProxyHostWithNonstandardPortIsUsed() throws Exception {
		testUriPrefixMatchesExpected("8889", "127.0.0.1,foo", "", "",
	...
	public void allowedUriHostIsUsed() throws Exception {
		testUriPrefixMatchesExpected("8888", "127.0.0.1,foo", "", "foo",
				MultiValueTable.from(new String[] {}, new String[] {}), "http://foo");
	}

	@Test
	public void allowedUriHostWithStandardPortAreUsed() throws Exception {
		testUriPrefixMatchesExpected("8888", "127.0.0.1,foo", "", "foo:8888",
				MultiValueTable.from(new String[] {}, new String[] {}), "http://foo:8888");
	}

	@Test
	public void allowedUriAndNonstandardPortAreUsed() throws Exception {
		testUriPrefixMatchesExpected("8889", "127.0.0.1,foo", "", "foo:8889",
				MultiValueTable.from(new String[] {}, new String[] {}), "http://foo:8889");
	}

	@Test
	public void httpsProtocolFromUriIsUsed() throws Exception {
		testUriPrefixMatchesExpected("8888", "127.0.0.1", "https", "",
				MultiValueTable.from(new String[] {}, new String[] {}), "https://127.0.0.1:8888");
	}
	...
	public void disallowedProxyHostAndPortAreIgnored() throws Exception {
		testUriPrefixMatchesExpected("8888", "127.0.0.1", "", "foo:8888",
				MultiValueTable.from(new String[] { "x-forwarded-host" }, new String[] { "foo:8888" }),
				"http://127.0.0.1:8888");
	}

	@Test
	public void disallowedProxyWithStandardPortIsIgnoredIfPortIsNotStandardAndHostNotAllowed() throws Exception {
		testUriPrefixMatchesExpected("8889", "127.0.0.1", "", "",
				MultiValueTable.from(new String[] { "x-forwarded-host" }, new String[] { "foo:8888" }),
				"http://127.0.0.1:8889");
	}
	...
	public void disallowedProxyWithStandardPortIsIgnoredIfPortIsNotStandard() throws Exception {
		testUriPrefixMatchesExpected("8889", "127.0.0.1", "", "",
				MultiValueTable.from(new String[] { "x-forwarded-host" }, new String[] { "127.0.0.1:8888" }),
				"http://127.0.0.1:8889");
	}
	...
	public void disallowedUriWithAllowedHostButDisallowedPortIsIgnored() throws Exception {
		testUriPrefixMatchesExpected("8888", "127.0.0.1,foo", "", "foo:8889",
				MultiValueTable.from(new String[] { "x-forwarded-host" }, new String[] { "foo:8889" }),
				"http://127.0.0.1:8888");
	}

	private void testUriPrefixMatchesExpected(String fProxyPort, String fProxyBindTo, String uriScheme, String uriHost,
			MultiValueTable<String, String> headers, String resultUriPrefix) throws Exception {
		String schemeHostAndPort = UriFilterProxyHeaderParser
				.parse(fakePortOption(fProxyPort), fakeBindToOption(fProxyBindTo), uriScheme, uriHost, headers)
				.toString();
		assertTrue(String.format(
				"schemeHostAndPort %s does not match expected %s; portConfig=\"%s\", bindTo=\"%s\", uriScheme=\"%s\", uriHost=\"%s\", headers=%s, expected=\"%s\"",
				schemeHostAndPort, resultUriPrefix, fProxyPort, fProxyBindTo, uriScheme, uriHost, headers,
				resultUriPrefix), schemeHostAndPort.equals(resultUriPrefix));

	}

	private StringOption fakeBindToOption(String value) throws Exception {
		StringOption option = new StringOption(new Config().createSubConfig("fake"), "bindTo", "127.0.0.1", 0, false,
				false, "", "", new DummyStringCallback());
		option.setValue(value);
		return option;
	}

	private StringOption fakePortOption(String value) throws Exception {
		StringOption option = new StringOption(new Config().createSubConfig("fake"), "port", "8888", 0, false, false,
