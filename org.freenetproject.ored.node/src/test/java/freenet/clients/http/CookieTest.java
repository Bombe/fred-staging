...
public class CookieTest extends TestCase {
	...
	public void testEqualsObject() throws URISyntaxException {
		...
		assertEquals(cookie,
				new Cookie(validPath, VALID_NAME, VALID_VALUE, new Date(CurrentTimeUTC.getInMillis() + 60 * 1000)));
		...
		assertFalse(cookie
				.equals(new Cookie(new URI(VALID_PATH.toLowerCase()), VALID_NAME, VALID_VALUE, validExpiresDate)));
	...
	// TODO: getExpirationDate() is commented out because it is broken, see
	// ReceivedCookie.java
