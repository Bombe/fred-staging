...
public class CryptByteBufferTest {
	...
	private static final String ivPlainText = "6bc1bee22e409f96e93d7e117393172a"
			+ "ae2d8a571e03ac9c9eb76fac45af8e5130c81c46a35ce411e5fbc1191a0a52ef" + "f69f2445df4f9b17ad2b417be66c3710";

	private static final String[] plainText = { "0123456789abcdef1123456789abcdef2123456789abcdef3123456789abcdef",
			"0123456789abcdef1123456789abcdef", ivPlainText, ivPlainText, ivPlainText, ivPlainText };
	...
	private static final byte[][] ivs = { null, null,
	...
	public void testSuccessfulRoundTripByteArray() throws GeneralSecurityException {
		for (int i = 0; i < cipherTypes.length; i++) {
			...
			assertArrayEquals("CryptByteBufferType: " + type.name(), Hex.decode(plainText[i]), decipheredtext);
		}
	}
	...
	public void testSuccessfulRoundTripInPlaceOffset() throws GeneralSecurityException {
		...
		for (int i = 0; i < cipherTypes.length; i++) {
			...
			assertArrayEquals("CryptByteBufferType: " + type.name(), originalPlaintext,
	...
	public void testEncryptDirectByteBuffer() throws GeneralSecurityException {
		for (int i = 0; i < cipherTypes.length; i++) {
			...
			assertTrue(Arrays.equals(origPlaintext, copyPlaintext)); // Plaintext not
																		// modified.
			plaintext.clear();
			assertEquals(ciphertext.remaining(), origPlaintext.length);
			ByteBuffer deciphered = crypt.decryptCopy(ciphertext);
