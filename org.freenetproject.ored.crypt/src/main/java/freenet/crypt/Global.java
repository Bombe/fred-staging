...
/**
 * This class contains global public keys used by Freenet. These include the
 * Diffie-Hellman key exchange modulus, DSA groups, and any other future values
 *
 * @author Scott
 */
public final class Global {
	...
	/*
	 * NB: for some reason I can't explain, we're signing truncated hashes... So we need
	 ...
	 *
	 * Ever since 2ffce6060b346c3a671887b51849f88482b882a9 we are verifying using both the
	 * truncated and non-truncated version (wasting CPU cycles in the process)
	 *
	 * @see SSKBlock
	 *
	 * I guess it's not too bad since in most cases the signature will match on the first
	 * try: Anything inserted post 2007 is signed using a truncated hash.
	 */
