...
/**
 * Holds DSA group parameters. These are the public (possibly shared) values needed for
 * the DSA algorithm
 */
public class DSAGroup extends CryptoKey {
	...
	/**
	 * Parses a DSA Group from a string, where p, q, and g are in unsigned hex-strings,
	...
	public boolean equals(Object o) {
		if (this == o) // Not necessary, but a very cheap optimization
			return true;
		return (o instanceof DSAGroup) && p.equals(((DSAGroup) o).p) && q.equals(((DSAGroup) o).q)
