...
public class CTRBlockCipher {
	...
	/**
	 * The plaintext block counter. This is incremented (from [31] backwards) after each
	 * block encryption.
	 */
	private final byte[] counter;

	/**
	 * The ciphertext block counter. This is the result of encrypting the plaintext block
	 * counter. It is XOR'ed with the plaintext to get the ciphertext.
	 */
	 ...
	 * @param iv The initialization vector. This is the initial value of the plaintext
	 * counter. The plaintext is XORed with a sequence of bytes consisting of the
	 * encryption of successive values of the counter.
