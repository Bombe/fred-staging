 ...
 *
 * Thrown to indicate that a method has been passed an Enum value from one of the various
 * Type enums in freenet.crypt that is not supported by that method.
 *
 * @author unixninja92
 *
 */
