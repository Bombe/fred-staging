...
public abstract class RandomSource extends Random {
	...
	/**
	 * Returns a 32 bit random floating point number. With this method, all possible float
	 * values are approximately as likely to occur.
	 *
	 ...
	 * @param bias Value by which we multiply the entropy before counting it. Must be <=
	 * 1.0.
	 */
	 ...
	 * Must be <= 1.0.
	 */
	public abstract int acceptEntropyBytes(EntropySource myPacketDataSource, byte[] buf, int offset, int length,
			double bias);
