...
/**
 * Keeps track of curve names and specs for EC based algorithms available to Freenet. Also
 * includes DSA for legacy support of old network content.
 * @author unixninja92
 *
 */
public enum KeyPairType {
	...
	/**
	 * @deprecated DSA should only be used for legacy support of old network content.
	 * Replaced by {@link #ECP256}
	 */
	@Deprecated
	DSA(), ECP256("EC", "secp256r1", 91), ECP384("EC", "secp384r1", 120), ECP521("EC", "secp521r1", 158);
