...
/**
 * Keeps track of properties of different symmetric cipher algorithms available to Freenet
 * including key type, name of the algorithm, block size used, and iv length if required.
 * @author unixninja92
 *
 */
public enum CryptByteBufferType implements Serializable {
	...
	@Deprecated
	RijndaelECB(1, KeyType.Rijndael256), @Deprecated
	RijndaelECB128(2, KeyType.Rijndael256, 128), @Deprecated
	RijndaelPCFB(8, 32, KeyType.Rijndael256), AESCTR(16, 16, "AES/CTR/NOPADDING", KeyType.AES256), ChaCha128(32, 8,
			"CHACHA", KeyType.ChaCha128), ChaCha256(64, 8, "CHACHA", KeyType.ChaCha256);
	...
	/**
	 * Creates the RijndaelECB128 enum value. iv is null. and sets the non-standard
	 * blocksize.
	 * @param bitmask
	 * @param keyType The type of key the alg requires
	...
	/**
	 * Creates an enum value for the specified algorithm, keytype, and iv size. Also
	 * stores the name of the alg that java recognizes
	 * @param bitmask
	 * @param ivSize Size of the iv
