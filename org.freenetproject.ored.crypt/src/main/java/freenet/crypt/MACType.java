...
/**
 * Keeps track of properties of different Message Authentication Code algorithms available
 * to Freenet including key type, name of the algorithm, and iv length if required.
 * @author unixninja92
 *
 */
public enum MACType {

	HMACSHA256(1, "HmacSHA256", KeyType.HMACSHA256), HMACSHA384(2, "HmacSHA384", KeyType.HMACSHA384), HMACSHA512(2,
			"HmacSHA512", KeyType.HMACSHA512), Poly1305AES(2, "POLY1305-AES", 16, KeyType.POLY1305AES);
