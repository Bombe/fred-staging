...
public class FreenetURITest {
	...
	public void testDeriveRequestURIFromInsertURI() throws MalformedURLException {
		final FreenetURI chk = new FreenetURI(
		...
		final FreenetURI requestUriSSKPlain = new FreenetURI(
				"SSK@sdFxM0Z4zx4-gXhGwzXAVYvOUi6NRfdGbyJa797bNAg,ZP4aASnyZax8nYOvCOlUebegsmbGQIXfVzw7iyOsXEc,AQACAAE/");
		final FreenetURI insertUriSSKPlain = new FreenetURI(
