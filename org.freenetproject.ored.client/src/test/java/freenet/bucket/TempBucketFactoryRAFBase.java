...
import freenet.bucket.TempBucketFactory.TempBucket;
import freenet.bucket.TempBucketFactory.TempRandomAccessBuffer;
...
public abstract class TempBucketFactoryRAFBase extends RandomAccessBufferTestBase {
	...
	public void setUp() throws IOException {
		fg = new BucketFilenameGenerator(weakPRNG, true, f, "temp-raf-test-");
