...
public class OggPageTest extends TestCase {
	...
	public void testStripNonsenseInterruption() throws IOException {
		...
		InputStream goodData = getClass().getResourceAsStream("/filter/ogg/nonsensical_interruption_filtered.ogg");
	...
	public void testChecksum() throws IOException {
		DataInputStream input = new DataInputStream(getClass().getResourceAsStream("/filter/ogg/valid_checksum.ogg"));
		OggPage page = OggPage.readPage(input);
	...
	public void testInvalidChecksumInvalidates() throws IOException {
		DataInputStream input = new DataInputStream(getClass().getResourceAsStream("/filter/ogg/invalid_checksum.ogg"));
		OggPage page = OggPage.readPage(input);
