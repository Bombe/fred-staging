...
import freenet.lockablebuffer.EncryptedRandomAccessBuffer;
import freenet.lockablebuffer.EncryptedRandomAccessBufferType;
...
public class EncryptedRandomAccessBufferTest {
	...
	private final static EncryptedRandomAccessBufferType[] types = EncryptedRandomAccessBufferType.values();
	...
	public void testWrongERATType() throws IOException, GeneralSecurityException {
		...
		thrown.expectMessage("This is not an EncryptedRandomAccessBuffer"); // Different
																			// header
																			// lengths.
		EncryptedRandomAccessBuffer erat2 = new EncryptedRandomAccessBuffer(types[1], barat2, secret, false);
	}

	@Test
	public void testUnderlyingRandomAccessThingTooSmall() throws GeneralSecurityException, IOException {
		byte[] bytes = new byte[10];
		ByteArrayRandomAccessBuffer barat = new ByteArrayRandomAccessBuffer(bytes);
		thrown.expect(IOException.class);
		thrown.expectMessage("Underlying RandomAccessBuffer is not long enough to include the " + "footer.");
		EncryptedRandomAccessBuffer erat = new EncryptedRandomAccessBuffer(types[0], barat, secret, true);
	}
	...
	public void testWrongMasterSecret() throws IOException, GeneralSecurityException {
		...
		EncryptedRandomAccessBuffer erat2 = new EncryptedRandomAccessBuffer(types[0], barat2, new MasterSecret(),
				false);
	}

	@Test(expected = NullPointerException.class)
	public void testEncryptedRandomAccessThingNullInput1() throws GeneralSecurityException, IOException {
		byte[] bytes = new byte[10];
		ByteArrayRandomAccessBuffer barat = new ByteArrayRandomAccessBuffer(bytes);
	...
	@Test(expected = NullPointerException.class)
	public void testEncryptedRandomAccessThingNullByteArray() throws GeneralSecurityException, IOException {
		ByteArrayRandomAccessBuffer barat = new ByteArrayRandomAccessBuffer(null);
		EncryptedRandomAccessBuffer erat = new EncryptedRandomAccessBuffer(types[0], barat, secret, true);
	}

	@Test(expected = NullPointerException.class)
	public void testEncryptedRandomAccessThingNullBARAT() throws GeneralSecurityException, IOException {
		ByteArrayRandomAccessBuffer barat = null;
		EncryptedRandomAccessBuffer erat = new EncryptedRandomAccessBuffer(types[0], barat, secret, true);
	}

	@Test(expected = NullPointerException.class)
	public void testEncryptedRandomAccessThingNullInput3() throws GeneralSecurityException, IOException {
		byte[] bytes = new byte[10];
		ByteArrayRandomAccessBuffer barat = new ByteArrayRandomAccessBuffer(bytes);
	...
	public void testPreadFileOffsetTooBig() throws IOException, GeneralSecurityException {
		...
		int offset = 100;
		thrown.expect(IOException.class);
		thrown.expectMessage("Cannot read after end: trying to read from " + offset + " to " + (offset + len)
				+ " on block length " + erat.size());
	...
	public void testPwriteFileOffsetTooBig() throws IOException, GeneralSecurityException {
		...
		int offset = 100;
		thrown.expect(IOException.class);
		thrown.expectMessage("Cannot write after end: trying to write from " + offset + " to " + (offset + len)
				+ " on block length " + erat.size());
	...
	public void testClosePread() throws IOException, GeneralSecurityException {
		...
		byte[] result = new byte[20];
		thrown.expect(IOException.class);
		thrown.expectMessage("This RandomAccessBuffer has already been closed. It can no longer" + " be read from.");
	...
	public void testClosePwrite() throws IOException, GeneralSecurityException {
		...
		byte[] result = new byte[20];
		thrown.expect(IOException.class);
		thrown.expectMessage("This RandomAccessBuffer has already been closed. It can no longer" + " be written to.");
	...
	public void testStoreTo()
		...
		ClientContext context = new ClientContext(0, null, null, null, null, null, null, null, null, null, r, null,
