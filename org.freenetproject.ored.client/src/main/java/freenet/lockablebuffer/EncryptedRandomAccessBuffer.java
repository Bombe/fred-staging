...
public final class EncryptedRandomAccessBuffer implements LockableRandomAccessBuffer, Serializable { 
     ...
     * @param underlying The underlying RAT that will be storing the data. Must be larger than
    ...
    public static LockableRandomAccessBuffer create(DataInputStream dis, BucketFilenameGenerator fg, PersistentFileTracker persistentFileTracker, MasterSecret masterKey)
