...
/**
 * Stores information about the algorithms used, the version number, and the footer length
...
public enum EncryptedRandomAccessBufferType {
	...
	ChaCha128(1, 12, CryptByteBufferType.ChaCha128, MACType.HMACSHA256, 32), ChaCha256(2, 12,
			CryptByteBufferType.ChaCha256, MACType.HMACSHA256, 32);
	 ...
	 */
	private EncryptedRandomAccessBufferType(int bitmask, int magAndVerLen, CryptByteBufferType type, MACType macType,
			int macLen) {
