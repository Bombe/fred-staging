...
/**
 * An SSK is a Signed Subspace Key. { pubkey, cryptokey, filename } -> document,
 * basically. To insert you need the private key corresponding to pubkey. KSKs are
 * implemented via SSKs.
 *
 * This is just the key, so we have the hash of the pubkey, the entire cryptokey, and the
 * entire filename.
 */
