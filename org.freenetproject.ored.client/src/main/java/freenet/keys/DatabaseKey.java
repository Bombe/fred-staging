...
public class DatabaseKey {
	...
	/**
	 * Key Derivation Function for plugin stores: Use the database key as an HMAC key to
	 * an HMAC of the key plus some constant plus the storeIdentifier.
	...
	/**
	 * Key Derivation Function for client.dat: Use the database key as an HMAC key to an
	 * HMAC of the key plus some constant plus the storeIdentifier.
	 * @return An encryption key, as byte[].
	 */
