...
public class PlainManifestPutter extends BaseManifestPutter {
	...
	public PlainManifestPutter(ClientPutCallback clientCallback, HashMap<String, Object> manifestElements,
			short prioClass, FreenetURI target, String defaultName, InsertContext ctx, boolean getCHKOnly,
			boolean earlyEncode, boolean persistent, byte[] forceCryptoKey, ClientContext context)
