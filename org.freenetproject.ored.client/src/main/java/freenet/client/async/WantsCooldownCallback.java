...
/**
 * Interface for requests that require a callback when they go into cooldown. Called
 * object should schedule a job on the jobRunner if it is persistent and will change
 * things.
 */
