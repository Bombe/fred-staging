...
public class ManifestElementNew implements Serializable {
	...
	public ManifestElementNew(String name2, String fullName2, RandomAccessBucket data2, String mimeOverride2, long size) {
		this.name = name2;
    ...
    public ManifestElementNew(String name2, String fullName2, String mimeOverride2,
	...
	public boolean equals(Object o) {
		...
		if(o instanceof ManifestElementNew) {
			if(((ManifestElementNew)o).name.equals(name)) return true;
		}
		return false;
	}
