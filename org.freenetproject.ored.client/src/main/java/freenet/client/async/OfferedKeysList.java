...
public class OfferedKeysList extends BaseSendableGet implements RequestClient {
	...
	OfferedKeysList(NodeClientRequest core, RandomSource random, short priorityClass, boolean isSSK, boolean realTimeFlag) {
	...
	public SendableRequestSender getSender(ClientContext context) {
		return new SendableRequestSender() {
			...
			@Override
			public boolean send(NodeClientRequest core, final RequestScheduler sched, ClientContext context, ChosenBlock req) {
