...
public class SplitFileFetcherSegmentBlockChooser extends CooldownBlockChooser {
	...
	public SplitFileFetcherSegmentBlockChooser(int blocks, Random random, int maxRetries, int cooldownTries,
			long cooldownTime, SplitFileFetcherSegmentStorage segment, KeysFetchingLocally keysFetching,
			int ignoreLastBlock) {
