...
public class LowLevelGetException extends LowLevelException {
	...
	/**
	 * A downstream node is overloaded, and rejected the request. We should reduce our
	 * rate of sending requests.
	 */
	...
	/**
	 * Data successfully transferred, but was not valid (at the node key level i.e. before
	 * decode)
	 */
