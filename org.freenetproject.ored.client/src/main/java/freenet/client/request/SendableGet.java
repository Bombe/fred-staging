 ...
 * restarting downloads or losing uploads. (Some children of this class are actually
 * stored)
 */
public abstract class SendableGet extends BaseSendableGet implements LowLevelFailureHandler {
	...
	/**
	 * What keys are we interested in? For purposes of checking the datastore. This is in
	 * SendableGet, *not* KeyListener, in order to deal with it in smaller chunks.
	 */
	...
	/**
	 * An internal error occurred, effecting this SendableGet, independantly of any
	 * ChosenBlock's.
	 */
	@Override
	public void internalError(final Throwable t, final RequestScheduler sched, ClientContext context,
		...
		sched.callFailure(this, new LowLevelGetException(LowLevelGetException.INTERNAL_ERROR, t.getMessage(), t),
