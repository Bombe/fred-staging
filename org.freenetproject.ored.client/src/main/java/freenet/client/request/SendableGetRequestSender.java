...
public class SendableGetRequestSender implements SendableRequestSender {
	...
	/**
	 * Do the request, blocking. Called by RequestStarter. Also responsible for deleting
	 * it.
	 * @return True if a request was executed. False if caller should try to find another
	 * request, and remove this one from the queue.
	 */
	@Override
	public boolean send(NodeClientRequest core, final RequestScheduler sched, final ClientContext context,
