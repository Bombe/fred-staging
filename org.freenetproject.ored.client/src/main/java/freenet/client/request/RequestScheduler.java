...
public interface RequestScheduler {
	 ...
	 * Definition of "succeeded" will vary, but the point is most schedulers will run
	 * another request from the parentGrabArray in the near future on the theory that if
	 * one works, another may also work.
	 ...
	 * Note: If you don't want your requests to be subject to cooldown (e.g. in fproxy),
	 * make your max retry count less than this (and more than -1).
	 */
	 ...
	 * selected on a SendableRequest level, they are selected on a {SendableRequest,
	 * token} level.
	 */
