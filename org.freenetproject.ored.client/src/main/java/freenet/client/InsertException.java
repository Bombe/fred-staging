...
/**
 * Thrown when a high-level insert fails. For most failures, there will not be a stack
 * trace, or it will be inaccurate.
 */
public class InsertException extends Exception implements Cloneable {
	...
	/**
	 * Collect errors when there are multiple failures. The error mode will be
	 * FATAL_ERRORS_IN_BLOCKS or TOO_MANY_RETRIES_IN_BLOCKS i.e. a splitfile failed.
	 */
	...
	private static final HashMap<Integer, InsertExceptionMode> modes = new HashMap<Integer, InsertExceptionMode>();
	...
	/**
	 * Construct an InsertException from a bunch of error codes, typically from a
	 * splitfile insert.
	 */
