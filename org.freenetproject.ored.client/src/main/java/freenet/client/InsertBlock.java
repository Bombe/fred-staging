...
public class InsertBlock implements Serializable {
	...
	/**
	 * Null out the data so it doesn't get removed in removeFrom(). Call this when the
	 * data becomes somebody else's problem.
	 */
	...
	/**
	 * Null out the URI so it doesn't get removed in removeFrom(). Call this when the URI
