 ...
 * <p>
 * At the moment the only implementation is {@link SimpleToadletServer} which forwards the
...
public interface LinkFilterExceptionProvider {
	 ...
	 * @return {@code true} if the link should not be filtered, {@code false} if it should
	 * be filtered
	 */
