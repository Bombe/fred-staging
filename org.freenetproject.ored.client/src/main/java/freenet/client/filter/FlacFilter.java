...
/**
 * Filters native FLAC data. Format details may be found at
 * <a href="http://flac.sourceforge.net/format.html">
 * http://flac.sourceforge.net/format.html</a>
 *
 * @author sajack
 */
public class FlacFilter implements ContentDataFilter {
	...
	enum State {
		...
		UNINITIALIZED, STREAMINFO_FOUND, METADATA_FOUND, STREAM_FINISHED
