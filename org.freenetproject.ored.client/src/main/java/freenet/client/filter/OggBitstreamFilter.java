...
/**
 * Base class for specific logical bitstream filters. Subclasses should create a method
 * overriding <code>parse</code> which includes a call to the original method.
 *
 * @author sajack
 */
public class OggBitstreamFilter {
	...
	/**
	 * Does minimal validation of a page in this Ogg logical bitstream. Should be extended
	 * by subclasses.
