...
/**
 * Filters Ogg container files. These containers contain one or more logical bitstreams of
 * data encapsulated into a physical bitstream. The data is broken into variable length
 * pages, consisting of a header and 0-255 segments of 0-255 bytes. For more details refer
 * to <a href=
 * "http://www.xiph.org/ogg/doc/rfc3533.txt">http://www.xiph.org/ogg/doc/rfc3533.txt</a>
 *
 * @author sajack
 */
