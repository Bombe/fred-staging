...
public interface ClientEventProducer {
	...
	/**
	 * Adds an EventListener that will receive all events produced by the implementing
	 * object.
	...
	/**
	 * Removes an EventListener that will no loger receive events produced by the
	 * implementing object.
