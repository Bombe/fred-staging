...
public class DelayedFreeBucket implements Bucket, Serializable, DelayedFree {
	...
	/**
	 * Has the bucket been migrated to a RandomAccessBucket? If so it should not be
	 * accessed again, and in particular it should not be freed, since the new
	 * DelayedFreeRandomAccessBucket will share share the underlying RandomAccessBucket.
	 */
