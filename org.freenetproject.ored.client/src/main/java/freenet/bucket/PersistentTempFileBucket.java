...
public class PersistentTempFileBucket extends TempFileBucket implements Serializable {
    ...
    public PersistentTempFileBucket(long id, BucketFilenameGenerator generator, PersistentFileTracker tracker) {
		this(id, generator, tracker, true);
	}
	
	protected PersistentTempFileBucket(long id, BucketFilenameGenerator generator, PersistentFileTracker tracker, boolean deleteOnFree) {
