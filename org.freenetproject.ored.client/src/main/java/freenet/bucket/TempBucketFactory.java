...
public class TempBucketFactory implements BucketFactory, LockableRandomAccessBufferFactory {
	...
	public TempBucketFactory(Executor executor, BucketFilenameGenerator filenameGenerator, long maxBucketSizeKeptInRam, long maxRamUsed, Random weakPRNG, boolean reallyEncrypt, long minDiskSpace, MasterSecret masterSecret) {
