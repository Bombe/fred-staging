...
public class BaseL10nTest extends TestCase {
	...
	public void testAddL10nSubstitution() {
		...
		l10n.addL10nSubstitution(node, "test.substitution", new String[] { "bold" }, new HTMLNode[] { boldNode });
	...
	public void testAddL10nSubstitutionDouble() {
		...
		l10n.addL10nSubstitution(node, "test.doubleSubstitution", new String[] { "tag" }, new HTMLNode[] { tagNode });
	...
	public void testAddL10nSubstitutionSelfNested() throws Exception {
		...
		// it would be nice to handle this correctly, but it seems like more trouble than
		// it's worth
	...
	public static final BaseL10n createL10n(LANGUAGE lang) {
		...
		return new BaseL10n("", "freenet.l10n.${lang}.properties", overrideFile.getPath(), lang);
	}
	...
	public static final BaseL10n createTestL10n(LANGUAGE lang) {
		...
		return new BaseL10n("/test/", "freenet.l10n.${lang}.properties", overrideFile.getPath(), lang);
	}
