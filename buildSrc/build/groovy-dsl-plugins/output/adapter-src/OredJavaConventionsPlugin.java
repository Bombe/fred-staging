...
/**
 * Precompiled ored.java-conventions script plugin.
 **/
public class OredJavaConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_OredJavaConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("org.javamodularity.moduleplugin");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_OredJavaConventions").asSubclass(BasicScript.class);
