...
public class SubConfig implements Comparable<SubConfig> {
	...
	public void register(String optionName, int defaultValue, int sortOrder, boolean expert, boolean forceWrite,
			String shortDesc, String longDesc, IntCallback cb, boolean isSize) {
		if (cb == null)
	...
	public void register(String optionName, long defaultValue, int sortOrder, boolean expert, boolean forceWrite,
			String shortDesc, String longDesc, LongCallback cb, boolean isSize) {
		if (cb == null)
	...
	public void register(String optionName, int defaultValue, int sortOrder, boolean expert, boolean forceWrite,
		...
		if (cb == null)
			cb = new NullIntCallback();
		register(new BandwidthOption(this, optionName, defaultValue, sortOrder, expert, forceWrite, shortDesc, longDesc,
				cb));
	}
	...
	public void register(String optionName, String defaultValueString, int sortOrder, boolean expert,
		...
		register(new IntOption(this, optionName, defaultValueString, sortOrder, expert, forceWrite, shortDesc, longDesc,
				cb, dimension));
	}

	/**
	 * @deprecated Replaced by
	 * {@link #register(String, String, int, boolean, boolean, String, String, IntCallback, Dimension)}
	 */
	@Deprecated
	public void register(String optionName, String defaultValueString, int sortOrder, boolean expert,
	...
	public void register(String optionName, String defaultValueString, int sortOrder, boolean expert,
		...
		if (cb == null)
			cb = new NullLongCallback();
		register(new LongOption(this, optionName, defaultValueString, sortOrder, expert, forceWrite, shortDesc,
				longDesc, cb, isSize));
	}
	...
	public void register(String optionName, String defaultValueString, int sortOrder, boolean expert,
		...
		if (cb == null)
			cb = new NullIntCallback();
		register(new BandwidthOption(this, optionName, defaultValueString, sortOrder, expert, forceWrite, shortDesc,
				longDesc, cb));
	}

	public void register(String optionName, boolean defaultValue, int sortOrder, boolean expert, boolean forceWrite,
			String shortDesc, String longDesc, BooleanCallback cb) {
		if (cb == null)
			cb = new NullBooleanCallback();
		register(new BooleanOption(this, optionName, defaultValue, sortOrder, expert, forceWrite, shortDesc, longDesc,
				cb));
	}

	public void register(String optionName, String defaultValue, int sortOrder, boolean expert, boolean forceWrite,
			String shortDesc, String longDesc, StringCallback cb) {
		if (cb == null)
			cb = new NullStringCallback();
		register(new StringOption(this, optionName, defaultValue, sortOrder, expert, forceWrite, shortDesc, longDesc,
				cb));
	}

	public void register(String optionName, short defaultValue, int sortOrder, boolean expert, boolean forceWrite,
			String shortDesc, String longDesc, ShortCallback cb, boolean isSize) {
		if (cb == null)
	...
	public void register(String optionName, String[] defaultValue, int sortOrder, boolean expert, boolean forceWrite,
		...
		register(new StringArrOption(this, optionName, defaultValue, sortOrder, expert, forceWrite, shortDesc, longDesc,
				cb));
	}
	...
	/**
	 * Called when the object we are attached to has finished init. After this point, the
	 * callbacks are authoritative for values of config variables, and will be called when
	...
	public SimpleFieldSet exportFieldSet(Config.RequestType configRequestType, boolean withDefaults) {
		...
		// FIXME is any locking at all necessary here? After it has finished init, it's
		// constant...
		synchronized (this) {
	...
	/**
	 * If the option's value is equal to the provided old default, then set it to the new
	 * default. Used to deal with changes to important options where this is not handled
	 * automatically because the option's value is written to the .ini.
