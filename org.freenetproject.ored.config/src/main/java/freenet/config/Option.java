...
public abstract class Option<T> {
	...
	/**
	 * Used in alt="" to label a box with the option name used in the config file. FIXME
	 * get rid of said alt=""? Not much use for most users. See caller.
	 */
	...
	/**
	 * Get the current value. This is the value in use if we have finished initialization,
	 * otherwise it is the value set at startup (possibly the default).
	 */
	...
	/**
	 * Set to the default. Don't use after completed initialization, as this does not call
	 * the callback.
	 */
